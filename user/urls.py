...
from .views import dashboard_view, login_view, logout_view, users_view, create_user_view, update_user_view
...
urlpatterns = [
    ...
    path('users/update/<str:pk>', update_user_view, name='user-update-view'),
